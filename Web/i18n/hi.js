...
window.RatingsPluginI18n.hi = {
            ...
            addNewRow: 'नई पंक्ति जोड़ें', addToARow: 'पंक्ति में जोड़ें', agree: 'सहमत', allRatings: 'सभी रेटिंग',
            allowOthersToFollowMe: 'दूसरों को मुझे फ़ॉलो करने दें', background: 'पृष्ठभूमि', block: 'ब्लॉक करें',
            clickToView: 'देखने के लिए क्लिक करें', close: 'बंद करें', comments: 'टिप्पणियाँ',
            communityRating: 'कम्युनिटी रेटिंग', createRow: 'पंक्ति बनाएँ',
            defaultStyleApplied: 'डिफ़ॉल्ट स्टाइल लागू', deleteRow: 'पंक्ति हटाएँ', disagree: 'असहमत',
            dismiss: 'खारिज करें', editRating: 'रेटिंग संपादित करें', emojis: 'इमोजी',
            enterCustomTitle: 'कस्टम शीर्षक दर्ज करें...', enterUsername: 'उपयोगकर्ता नाम दर्ज करें...',
            filterUsers: 'उपयोगकर्ता फ़िल्टर करें...', friend: 'मित्र',
            genreBreakdownByWatchTime: 'देखे गए समय के अनुसार शैली विभाजन', genreTasteMatch: 'शैली रुचि मेल',
            gifs: 'GIF', headerBackground: 'हेडर पृष्ठभूमि', incomingRequests: 'प्राप्त अनुरोध',
            jumpToLatest: 'नवीनतम पर जाएँ', leftoverTrickplayData: 'बची हुई trickplay डेटा',
            loadingActivity: 'गतिविधि लोड हो रही है...', loadingAvailableTypes: 'उपलब्ध प्रकार लोड हो रहे हैं...',
            loadingCategories: 'श्रेणियाँ लोड हो रही हैं...', loadingGenres: 'शैलियाँ लोड हो रही हैं...',
            loadingProfile: 'प्रोफ़ाइल लोड हो रही है...', loadingRatings: 'रेटिंग लोड हो रही हैं...',
            loadingReviews: 'समीक्षाएँ लोड हो रही हैं...', manage: 'प्रबंधित करें', messageColor: 'संदेश का रंग:',
            moreActions: 'अधिक क्रियाएँ', moveRowDown: 'पंक्ति नीचे ले जाएँ', moveRowUp: 'पंक्ति ऊपर ले जाएँ',
            myRatingsHighest: 'मेरी रेटिंग (उच्चतम)', myRatingsLowest: 'मेरी रेटिंग (न्यूनतम)', nameAZ: 'नाम A-Z',
            newestFirst: 'नवीनतम पहले', nicknameColor: 'उपनाम का रंग:', noActivityYet: 'अभी तक कोई गतिविधि नहीं',
            noBlockedUsers: 'कोई अवरुद्ध उपयोगकर्ता नहीं',
            noCommentsYetBeTheFirst: 'अभी तक कोई टिप्पणी नहीं। पहले बनें!',
            noDescriptionAvailable: 'कोई विवरण उपलब्ध नहीं।', noGenresFound: 'कोई शैली नहीं मिली',
            noGifsFound: 'कोई GIF नहीं मिला', noItemsFound: 'कोई आइटम नहीं मिला',
            noListsCreatedYet: 'अभी तक कोई सूची नहीं बनाई', noMatchesFound: 'कोई मेल नहीं मिला।',
            noMoreItems: 'और कोई आइटम नहीं', noOneElseHasWatchedEnoughYet: 'अभी तक किसी और ने पर्याप्त नहीं देखा',
            noOnlineUsers: 'कोई ऑनलाइन उपयोगकर्ता नहीं',
            noOtherUsersOnThisServerYet: 'इस सर्वर पर अभी अन्य उपयोगकर्ता नहीं',
            noPendingRequests: 'कोई लंबित अनुरोध नहीं', noRecentActivity: 'कोई हालिया गतिविधि नहीं',
            noResultsFound: 'कोई परिणाम नहीं मिला', noReviewsYet: 'अभी तक कोई समीक्षा नहीं',
            notAcceptingRequests: 'अनुरोध स्वीकार नहीं कर रहे', nothingWatchedYet: 'अभी तक कुछ नहीं देखा',
            onYourServer: 'आपके सर्वर पर', penaltyApplied: 'दंड लागू', permissions: 'अनुमतियाँ:', privacy: 'गोपनीयता',
            profileInformation: 'प्रोफ़ाइल जानकारी', profileSettings: 'प्रोफ़ाइल सेटिंग्स',
            rateThisTitle: 'इस शीर्षक को रेट करें', rejectionReason: 'अस्वीकृति का कारण...',
            removeHeaderBackground: 'हेडर पृष्ठभूमि हटाएँ', removeRating: 'रेटिंग हटाएँ',
            requestFromCatalog: 'कैटलॉग से अनुरोध करें', requestThisTitle: 'इस शीर्षक का अनुरोध करें',
            review: 'समीक्षा', rowTitle: 'पंक्ति शीर्षक', save: 'सहेजें', saveChanges: 'परिवर्तन सहेजें',
            scrollLeft: 'बाएँ स्क्रॉल करें', scrollRight: 'दाएँ स्क्रॉल करें', searchError: 'खोज त्रुटि',
            searchFailed: 'खोज विफल', searchForUsersToAddAsFriends: 'मित्र जोड़ने के लिए उपयोगकर्ता खोजें',
            searching: 'खोजा जा रहा है...',
            selectACategoryAboveOrSearchForMedia: 'ऊपर से श्रेणी चुनें या मीडिया खोजें',
            selectACategoryOrTypeToSearch: 'श्रेणी चुनें या खोजने के लिए लिखें...', selectMedia: 'मीडिया चुनें',
            selectUser: 'उपयोगकर्ता चुनें...', sendAPrivateMessage: 'निजी संदेश भेजें',
            sentRequests: 'भेजे गए अनुरोध', serverRestarting: 'सर्वर पुनः प्रारंभ हो रहा है',
            shareYourThoughtsAboutThisTitle: 'इस शीर्षक पर अपने विचार साझा करें...',
            showAllRandom: 'सभी दिखाएँ (यादृच्छिक)', showMyActivityFeed: 'मेरी गतिविधि दिखाएँ',
            showMyRatingsToOthers: 'दूसरों को मेरी रेटिंग दिखाएँ', sortBy: 'इसके अनुसार क्रमबद्ध करें:',
            startFromTheBeginning: 'शुरू से शुरू करें', startWhereTheyAreNow: 'जहाँ वे अभी हैं वहाँ से शुरू करें',
            status: 'स्थिति', styleApplied: 'स्टाइल लागू', submitRating: 'रेटिंग सबमिट करें',
            tellOthersAboutYourself: 'अपने बारे में बताएँ...', testNotification: 'परीक्षण सूचना',
            textStyle: 'टेक्स्ट शैली:', toggleFullscreen: 'पूर्ण स्क्रीन टॉगल करें',
