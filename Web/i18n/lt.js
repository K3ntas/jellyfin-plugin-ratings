...
window.RatingsPluginI18n.lt = {
            ...
            duplicateKeepBoth: 'Palikti abu', duplicateKeepAll: 'Palikti visus',
            duplicateKeepBothTooltip: 'Palikti visas kopijas (pvz. dvi kalbos) ir nebe rodyti šios grupės',
            duplicateKeptHidden: 'Paslėpta grupių, pažymėtų „Palikti abu“: {n}.', duplicateShowKept: 'Vėl rodyti',
            duplicateKeepFailed: 'Nepavyko išsaugoti pasirinkimo.',
            hideMyProfile: 'Slėpti mano profilį - niekas kitas negalės jo atidaryti, o aš nebūsiu rodomas naudotojų sąrašuose ir paieškoje',
            profileIsPrivate: 'Šis profilis privatus',
            adminRemoveReview: 'Pašalinti (admin)', adminRemoveReviewPrompt: 'Pašalinti šią apžvalgą?',
            adminRemoveReviewTextOnly: 'Tik apžvalgą', adminRemoveReviewAndRating: 'Apžvalgą ir įvertinimą',
            adminReviewRemoved: 'Apžvalga pašalinta', adminRatingRemoved: 'Įvertinimas ir apžvalga pašalinti',
            adminRemoveFailed: 'Nepavyko pašalinti',
