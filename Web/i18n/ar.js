...
window.RatingsPluginI18n.ar = {
            ...
            addNewRow: 'إضافة صف', addToARow: 'إضافة إلى صف', agree: 'أوافق', allRatings: 'كل التقييمات',
            allowOthersToFollowMe: 'السماح للآخرين بمتابعتي', background: 'الخلفية', block: 'حظر',
            clickToView: 'انقر للعرض', close: 'إغلاق', comments: 'التعليقات', communityRating: 'تقييم المجتمع',
            createRow: 'إنشاء صف', defaultStyleApplied: 'تم تطبيق النمط الافتراضي', deleteRow: 'حذف الصف',
            disagree: 'لا أوافق', dismiss: 'تجاهل', editRating: 'تعديل التقييم', emojis: 'الرموز التعبيرية',
            enterCustomTitle: 'أدخل عنوانًا...', enterUsername: 'أدخل اسم المستخدم...',
            filterUsers: 'تصفية المستخدمين...', friend: 'صديق',
            genreBreakdownByWatchTime: 'توزيع الأنواع حسب وقت المشاهدة', genreTasteMatch: 'تطابق الذوق حسب النوع',
            gifs: 'صور GIF', headerBackground: 'خلفية الرأس', incomingRequests: 'الطلبات الواردة',
            jumpToLatest: 'الانتقال إلى الأحدث', leftoverTrickplayData: 'بيانات trickplay المتبقية',
            loadingActivity: 'جارٍ تحميل النشاط...', loadingAvailableTypes: 'جارٍ تحميل الأنواع المتاحة...',
            loadingCategories: 'جارٍ تحميل الفئات...', loadingGenres: 'جارٍ تحميل الأنواع...',
            loadingProfile: 'جارٍ تحميل الملف الشخصي...', loadingRatings: 'جارٍ تحميل التقييمات...',
            loadingReviews: 'جارٍ تحميل المراجعات...', manage: 'إدارة', messageColor: 'لون الرسالة:',
            moreActions: 'إجراءات أخرى', moveRowDown: 'تحريك الصف لأسفل', moveRowUp: 'تحريك الصف لأعلى',
            myRatingsHighest: 'تقييماتي (الأعلى)', myRatingsLowest: 'تقييماتي (الأدنى)', nameAZ: 'الاسم أ-ي',
            newestFirst: 'الأحدث أولاً', nicknameColor: 'لون اللقب:', noActivityYet: 'لا يوجد نشاط بعد',
            noBlockedUsers: 'لا يوجد مستخدمون محظورون', noCommentsYetBeTheFirst: 'لا توجد تعليقات بعد. كن الأول!',
            noDescriptionAvailable: 'لا يوجد وصف متاح.', noGenresFound: 'لم يتم العثور على أنواع',
            noGifsFound: 'لم يتم العثور على صور GIF', noItemsFound: 'لم يتم العثور على عناصر',
            noListsCreatedYet: 'لم يتم إنشاء قوائم بعد', noMatchesFound: 'لم يتم العثور على تطابق.',
            noMoreItems: 'لا مزيد من العناصر', noOneElseHasWatchedEnoughYet: 'لم يشاهد أحد آخر ما يكفي بعد',
            noOnlineUsers: 'لا يوجد مستخدمون متصلون',
            noOtherUsersOnThisServerYet: 'لا يوجد مستخدمون آخرون على هذا الخادم بعد',
            noPendingRequests: 'لا توجد طلبات معلقة', noRecentActivity: 'لا يوجد نشاط حديث',
            noResultsFound: 'لم يتم العثور على نتائج', noReviewsYet: 'لا توجد مراجعات بعد',
            notAcceptingRequests: 'لا يقبل الطلبات', nothingWatchedYet: 'لم تتم مشاهدة أي شيء بعد',
            onYourServer: 'على خادمك', penaltyApplied: 'تم تطبيق العقوبة', permissions: 'الصلاحيات:',
            privacy: 'الخصوصية', profileInformation: 'معلومات الملف الشخصي', profileSettings: 'إعدادات الملف الشخصي',
            rateThisTitle: 'قيّم هذا العنوان', rejectionReason: 'سبب الرفض...',
            removeHeaderBackground: 'إزالة خلفية الرأس', removeRating: 'إزالة التقييم',
            requestFromCatalog: 'الطلب من الكتالوج', requestThisTitle: 'اطلب هذا العنوان', review: 'مراجعة',
            rowTitle: 'عنوان الصف', save: 'حفظ', saveChanges: 'حفظ التغييرات', scrollLeft: 'التمرير لليسار',
            scrollRight: 'التمرير لليمين', searchError: 'خطأ في البحث', searchFailed: 'فشل البحث',
            searchForUsersToAddAsFriends: 'ابحث عن مستخدمين لإضافتهم كأصدقاء', searching: 'جارٍ البحث...',
            selectACategoryAboveOrSearchForMedia: 'اختر فئة أعلاه أو ابحث عن وسائط',
            selectACategoryOrTypeToSearch: 'اختر فئة أو اكتب للبحث...', selectMedia: 'اختر الوسائط',
            selectUser: 'اختر مستخدمًا...', sendAPrivateMessage: 'إرسال رسالة خاصة', sentRequests: 'الطلبات المرسلة',
            serverRestarting: 'إعادة تشغيل الخادم', shareYourThoughtsAboutThisTitle: 'شارك رأيك في هذا العنوان...',
            showAllRandom: 'عرض الكل (عشوائي)', showMyActivityFeed: 'إظهار نشاطي',
            showMyRatingsToOthers: 'إظهار تقييماتي للآخرين', sortBy: 'الترتيب حسب:',
            startFromTheBeginning: 'البدء من البداية', startWhereTheyAreNow: 'البدء من حيث هم الآن', status: 'الحالة',
            styleApplied: 'تم تطبيق النمط', submitRating: 'إرسال التقييم',
            tellOthersAboutYourself: 'أخبر الآخرين عن نفسك...', testNotification: 'إشعار تجريبي',
            textStyle: 'نمط النص:', toggleFullscreen: 'تبديل ملء الشاشة',
