...
window.RatingsPluginI18n.es = {
            ...
            addAFilm: 'Añadir película', addFilmPlaceholder: 'Buscar título o id de IMDb…', avgLabel: 'Media',
            back: 'Volver', backToProfile: 'Volver al perfil', filmsLabel: 'Películas', hoursLabel: 'Horas',
            memberSince: 'Miembro desde', notOnServer: 'No está en el servidor', recentActivity: 'Actividad reciente',
            recentReviews: 'Reseñas recientes', sectionFavoriteFilms: 'Películas favoritas', settings: 'Ajustes',
            showsLabel: 'Series', similarTaste: 'Gustos parecidos', statsTitle: 'Estadísticas', taste: 'Gustos',
            addNewRow: 'Añadir fila', addToARow: 'Añadir a una fila', agree: 'De acuerdo',
            allRatings: 'Todas las valoraciones', allowOthersToFollowMe: 'Permitir que otros me sigan',
            background: 'Fondo', block: 'Bloquear', clickToView: 'Clic para ver', close: 'Cerrar',
            comments: 'Comentarios', communityRating: 'Valoración de la comunidad', createRow: 'Crear fila',
            defaultStyleApplied: 'Estilo por defecto aplicado', deleteRow: 'Eliminar fila', disagree: 'En desacuerdo',
            dismiss: 'Descartar', editRating: 'Editar valoración', emojis: 'Emojis',
            enterCustomTitle: 'Escribe un título...', enterUsername: 'Escribe un usuario...',
            filterUsers: 'Filtrar usuarios...', friend: 'Amigo',
            genreBreakdownByWatchTime: 'Desglose de géneros por tiempo visto',
            genreTasteMatch: 'Coincidencia de gustos por género', gifs: 'GIFs',
            headerBackground: 'Fondo del encabezado', incomingRequests: 'Solicitudes recibidas',
            jumpToLatest: 'Ir al último', leftoverTrickplayData: 'Datos de trickplay sobrantes',
            loadingActivity: 'Cargando actividad...', loadingAvailableTypes: 'Cargando tipos disponibles...',
            loadingCategories: 'Cargando categorías...', loadingGenres: 'Cargando géneros...',
            loadingProfile: 'Cargando perfil...', loadingRatings: 'Cargando valoraciones...',
            loadingReviews: 'Cargando reseñas...', manage: 'Gestionar', messageColor: 'Color del mensaje:',
            moreActions: 'Más acciones', moveRowDown: 'Bajar la fila', moveRowUp: 'Subir la fila',
            myRatingsHighest: 'Mis valoraciones (mayor)', myRatingsLowest: 'Mis valoraciones (menor)',
            nameAZ: 'Nombre A-Z', newestFirst: 'Más recientes primero', nicknameColor: 'Color del apodo:',
            noActivityYet: 'Aún no hay actividad', noBlockedUsers: 'No hay usuarios bloqueados',
            noCommentsYetBeTheFirst: 'Aún no hay comentarios. ¡Sé el primero!',
            noDescriptionAvailable: 'No hay descripción disponible.', noGenresFound: 'No se han encontrado géneros',
            noGifsFound: 'No se han encontrado GIFs', noItemsFound: 'No se han encontrado elementos',
            noListsCreatedYet: 'Aún no has creado listas', noMatchesFound: 'No se han encontrado coincidencias.',
            noMoreItems: 'No hay más elementos',
            noOneElseHasWatchedEnoughYet: 'Nadie más ha visto lo suficiente todavía',
            noOnlineUsers: 'No hay usuarios en línea',
            noOtherUsersOnThisServerYet: 'Todavía no hay otros usuarios en este servidor',
            noPendingRequests: 'No hay solicitudes pendientes', noRecentActivity: 'No hay actividad reciente',
            noResultsFound: 'No se han encontrado resultados', noReviewsYet: 'Aún no hay reseñas',
            notAcceptingRequests: 'No acepta solicitudes', nothingWatchedYet: 'Aún no has visto nada',
            onYourServer: 'En tu servidor', penaltyApplied: 'Sanción aplicada', permissions: 'Permisos:',
            privacy: 'Privacidad', profileInformation: 'Información del perfil',
            profileSettings: 'Ajustes del perfil', rateThisTitle: 'Valorar este título',
            rejectionReason: 'Motivo del rechazo...', removeHeaderBackground: 'Quitar fondo del encabezado',
            removeRating: 'Quitar valoración', requestFromCatalog: 'Solicitar del catálogo',
            requestThisTitle: 'Solicitar este título', review: 'Reseña', rowTitle: 'Título de la fila',
            save: 'Guardar', saveChanges: 'Guardar cambios', scrollLeft: 'Desplazar a la izquierda',
            scrollRight: 'Desplazar a la derecha', searchError: 'Error de búsqueda',
            searchFailed: 'La búsqueda ha fallado',
            searchForUsersToAddAsFriends: 'Busca usuarios para añadir como amigos', searching: 'Buscando...',
            selectACategoryAboveOrSearchForMedia: 'Elige una categoría arriba o busca contenido',
            selectACategoryOrTypeToSearch: 'Elige una categoría o escribe para buscar...',
            selectMedia: 'Seleccionar contenido', selectUser: 'Seleccionar usuario...',
            sendAPrivateMessage: 'Enviar un mensaje privado', sentRequests: 'Solicitudes enviadas',
            serverRestarting: 'Reiniciando el servidor',
            shareYourThoughtsAboutThisTitle: 'Comparte tu opinión sobre este título...',
            showAllRandom: 'Mostrar todo (aleatorio)', showMyActivityFeed: 'Mostrar mi actividad',
            showMyRatingsToOthers: 'Mostrar mis valoraciones a otros', sortBy: 'Ordenar por:',
            startFromTheBeginning: 'Empezar desde el principio', startWhereTheyAreNow: 'Empezar donde están ahora',
            status: 'Estado', styleApplied: 'Estilo aplicado', submitRating: 'Enviar valoración',
            tellOthersAboutYourself: 'Cuenta algo sobre ti...', testNotification: 'Notificación de prueba',
            textStyle: 'Estilo de texto:', toggleFullscreen: 'Pantalla completa',
            typeAtLeast2Characters: 'Escribe al menos 2 caracteres', unfriend: 'Eliminar amistad',
            ...
            duplicateDeleteFailed: 'No se pudo eliminar esa copia.', duplicateKeepThis: 'Conservar esta',
            duplicateKeepThisTooltip: 'Conservar esta copia en su lugar',
            duplicatesLoadFailed: 'Error al cargar los duplicados', retry: 'Reintentar',
            socialLoadFailed: 'No se pudo cargar. Inténtalo de nuevo.'
};
