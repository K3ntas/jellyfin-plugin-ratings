...
window.RatingsPluginI18n.de = {
            ...
            addNewRow: 'Neue Zeile', addToARow: 'Zu einer Zeile hinzufügen', agree: 'Zustimmen',
            allRatings: 'Alle Bewertungen', allowOthersToFollowMe: 'Anderen erlauben, mir zu folgen',
            background: 'Hintergrund', block: 'Blockieren', clickToView: 'Zum Ansehen klicken', close: 'Schließen',
            comments: 'Kommentare', communityRating: 'Community-Bewertung', createRow: 'Zeile erstellen',
            defaultStyleApplied: 'Standardstil angewendet', deleteRow: 'Zeile löschen', disagree: 'Nicht zustimmen',
            dismiss: 'Verwerfen', editRating: 'Bewertung bearbeiten', emojis: 'Emojis',
            enterCustomTitle: 'Eigenen Titel eingeben...', enterUsername: 'Benutzernamen eingeben...',
            filterUsers: 'Benutzer filtern...', friend: 'Freund', genreBreakdownByWatchTime: 'Genres nach Sehdauer',
            genreTasteMatch: 'Übereinstimmung des Genre-Geschmacks', gifs: 'GIFs',
            headerBackground: 'Kopfzeilen-Hintergrund', incomingRequests: 'Eingehende Anfragen',
            jumpToLatest: 'Zum Neuesten springen', leftoverTrickplayData: 'Übrig gebliebene Trickplay-Daten',
            loadingActivity: 'Aktivität wird geladen...', loadingAvailableTypes: 'Verfügbare Typen werden geladen...',
            loadingCategories: 'Kategorien werden geladen...', loadingGenres: 'Genres werden geladen...',
            loadingProfile: 'Profil wird geladen...', loadingRatings: 'Bewertungen werden geladen...',
            loadingReviews: 'Rezensionen werden geladen...', manage: 'Verwalten', messageColor: 'Nachrichtenfarbe:',
            moreActions: 'Weitere Aktionen', moveRowDown: 'Zeile nach unten', moveRowUp: 'Zeile nach oben',
            myRatingsHighest: 'Meine Bewertungen (höchste)', myRatingsLowest: 'Meine Bewertungen (niedrigste)',
            nameAZ: 'Name A-Z', newestFirst: 'Neueste zuerst', nicknameColor: 'Farbe des Spitznamens:',
            noActivityYet: 'Noch keine Aktivität', noBlockedUsers: 'Keine blockierten Benutzer',
            noCommentsYetBeTheFirst: 'Noch keine Kommentare. Sei der Erste!',
            noDescriptionAvailable: 'Keine Beschreibung verfügbar.', noGenresFound: 'Keine Genres gefunden',
            noGifsFound: 'Keine GIFs gefunden', noItemsFound: 'Keine Einträge gefunden',
            noListsCreatedYet: 'Noch keine Listen erstellt', noMatchesFound: 'Keine Treffer gefunden.',
            noMoreItems: 'Keine weiteren Einträge',
            noOneElseHasWatchedEnoughYet: 'Noch niemand sonst hat genug gesehen',
            noOnlineUsers: 'Keine Benutzer online',
            noOtherUsersOnThisServerYet: 'Noch keine anderen Benutzer auf diesem Server',
            noPendingRequests: 'Keine offenen Anfragen', noRecentActivity: 'Keine aktuelle Aktivität',
            noResultsFound: 'Keine Ergebnisse gefunden', noReviewsYet: 'Noch keine Rezensionen',
            notAcceptingRequests: 'Nimmt keine Anfragen an', nothingWatchedYet: 'Noch nichts gesehen',
            onYourServer: 'Auf deinem Server', penaltyApplied: 'Strafe angewendet', permissions: 'Berechtigungen:',
            privacy: 'Privatsphäre', profileInformation: 'Profilinformationen',
            profileSettings: 'Profileinstellungen', rateThisTitle: 'Diesen Titel bewerten',
            rejectionReason: 'Ablehnungsgrund...', removeHeaderBackground: 'Kopfzeilen-Hintergrund entfernen',
            removeRating: 'Bewertung entfernen', requestFromCatalog: 'Aus dem Katalog anfragen',
            requestThisTitle: 'Diesen Titel anfragen', review: 'Rezension', rowTitle: 'Zeilentitel',
            save: 'Speichern', saveChanges: 'Änderungen speichern', scrollLeft: 'Nach links scrollen',
            scrollRight: 'Nach rechts scrollen', searchError: 'Suchfehler', searchFailed: 'Suche fehlgeschlagen',
            searchForUsersToAddAsFriends: 'Nach Benutzern suchen, um sie als Freunde hinzuzufügen',
            searching: 'Wird gesucht...',
            selectACategoryAboveOrSearchForMedia: 'Oben eine Kategorie wählen oder Medien suchen',
            selectACategoryOrTypeToSearch: 'Kategorie wählen oder tippen zum Suchen...',
            selectMedia: 'Medien auswählen', selectUser: 'Benutzer auswählen...',
            sendAPrivateMessage: 'Private Nachricht senden', sentRequests: 'Gesendete Anfragen',
            serverRestarting: 'Server wird neu gestartet',
            shareYourThoughtsAboutThisTitle: 'Teile deine Meinung zu diesem Titel...',
            showAllRandom: 'Alle anzeigen (zufällig)', showMyActivityFeed: 'Meine Aktivität anzeigen',
            showMyRatingsToOthers: 'Meine Bewertungen anderen zeigen', sortBy: 'Sortieren nach:',
            startFromTheBeginning: 'Von Anfang an starten', startWhereTheyAreNow: 'Dort starten, wo sie gerade sind',
            status: 'Status', styleApplied: 'Stil angewendet', submitRating: 'Bewertung absenden',
            tellOthersAboutYourself: 'Erzähle etwas über dich...', testNotification: 'Testbenachrichtigung',
            textStyle: 'Textstil:', toggleFullscreen: 'Vollbild umschalten',
            typeAtLeast2Characters: 'Mindestens 2 Zeichen eingeben', unfriend: 'Freundschaft beenden',
